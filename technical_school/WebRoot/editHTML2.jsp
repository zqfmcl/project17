	  ...
	  <div style="width:1000px;margin:auto;border:2px solid #a1a1a1;padding:10px 40px; background:#dddddd;border-radius:25px;-moz-border-radius:25px;">
			...
			<form action="servlet/NRYtransform?tablename=<%=tablename%>&tableID=<%=columnID%>" method="post" enctype="multipart/form-data" onsubmit="return check()" >
			  <table style="border:2px solid #a1a1a1;text-align:right;">
			    ...
			    <tr><td>发布时间:</td><td  colspan="3" style="text-align:left;"><input type="text" name="date" id="time" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'});int=window.clearInterval(int)"></td></tr>
		    	...
		    	<tr><td>图片置顶:</td><td colspan="3" style="text-align:left;"><label><input name="column_top" type="radio" value="0" />是</label><label><input name="column_top" type="radio" value="1"  checked />否 </label> </td></tr>
			   <!--  <tr><td colspan="3">上传置顶图片:</td><td><input name="column_image" type="file"/></td></tr> -->
			   <tr><td>文章标题:</td><td colspan="3" style="text-align:left;"><input type="text" name="tittle" id="tittle" size="45"></td></tr>			    
			    <tr><td>文章摘要:</td><td colspan="3" style="text-align:left;"><input type="text" name="summary" id="tittle" size="45"></td></tr>
