 ...
 * 2017-07-03T16:59:15.230+08:00
 * Generated source version: 3.1.11
 * 
 */
@WebServiceClient(name = "LBEBusinessWebService", 
                  wsdlLocation = "http://218.56.106.138/service/LBEBusiness?wsdl",
...
public class LBEBusinessWebService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://218.56.106.138/service/LBEBusiness?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(LBEBusinessWebService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://218.56.106.138/service/LBEBusiness?wsdl");
        }
        WSDL_LOCATION = url;
    }
