...
<%
 ...
 %>
  ...
  <body>
    <div class="div-title">
		<span style="font-size: 20px;">添加产业</span> &nbsp;<a
	...
	<h5
			style="border-bottom-style:solid; border-bottom-width: 1px; border-bottom-color: #ccc;">添加产业信息</h5>
		
		<form action="Jbxx.do?method=cyxxAdd" id="form1" name="form1" method="post">
		<div class="form-editer">
			<table>
    		<tr>
    			<td>名称：</td><td><input id="cymc" name="cymc" type="text"/></td>
    		</tr><tr>
    			<td>父级：</td>
    			<td>
    				<select name="sjjd">
  ...
  <script type="text/javascript">
  	function savNgo(){
  		$("#form1").attr("action","Jbxx.do?method=cyxxcont");
