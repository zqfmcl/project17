 ...
 * 2017-06-01T09:28:21.392+08:00
 * Generated source version: 3.1.11
 * 
 */
@WebServiceClient(name = "LBEBusinessWebService", 
                  wsdlLocation = "http://222.175.251.218:10000/service/LBEBusiness?wsdl",
...
public class LBEBusinessWebService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://222.175.251.218:10000/service/LBEBusiness?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(LBEBusinessWebService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://222.175.251.218:10000/service/LBEBusiness?wsdl");
        }
        WSDL_LOCATION = url;
    }
